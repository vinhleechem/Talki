...
const highlights = [
  {
    ...
    description:
      "Thực hành hội thoại theo tình huống thật để nói tự nhiên và bớt run hơn mỗi ngày.",
  },
  {
    icon: Target,
    title: "Lộ trình rõ ràng",
    description:
      "Học từ kỹ năng giao tiếp cơ bản đến thuyết trình và xử lý các tình huống áp lực.",
  },
  {
    icon: Trophy,
    title: "Boss Fight thử thách",
    description:
      "Đối thoại với AI có cá tính mạnh như HR khó tính hoặc sếp khó chiều để nâng bản lĩnh.",
  },
];
...
const steps = [
  {
    ...
    description:
      "Nắm các nguyên tắc giao tiếp thực tế qua nội dung ngắn, dễ hiểu và dễ áp dụng.",
  },
  {
    icon: Brain,
    title: "2. Thực hành theo tình huống",
    description:
      "Ôn lại bằng bài luyện tương tác để biến kiến thức thành phản xạ giao tiếp.",
  },
  {
    icon: ShieldCheck,
    title: "3. Vào boss fight",
    description:
      "Đối mặt với các kịch bản khó và nhận đánh giá để biết mình cần cải thiện ở đâu.",
  },
];
    ...
    <div className="min-h-screen bg-background">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm font-bold text-muted-foreground">
                Nền tảng luyện giao tiếp cùng AI
              </p>
            </div>
          </div>
          ...
          <div className="space-y-6 text-center lg:text-left">
            ...
            <div className="space-y-4">
              <h1 className="text-5xl font-black leading-tight sm:text-6xl lg:text-7xl">
                Tự tin nói chuyện, phản hồi và thuyết phục với{" "}
                <span className="text-primary">Talki</span>
              </h1>
              <p className="mx-auto max-w-2xl text-lg font-medium text-muted-foreground lg:mx-0">
                Talki giúp bạn luyện giao tiếp qua video bài học, tình huống
                tương tác và những màn boss fight với AI để bớt ngại, nói mạch
                lạc hơn và xử lý tốt áp lực khi phỏng vấn, thuyết trình hoặc làm
                việc nhóm.
              </p>
            </div>
          ...
          <Card className="overflow-hidden bg-card neo-border-thick neo-shadow-lg">
            <div className="border-b-4 border-foreground bg-primary p-6 text-primary-foreground">
              ...
              <h2 className="mt-2 text-3xl font-black">
                Dành cho người muốn nói tốt hơn mỗi ngày
              </h2>
            </div>
            <div className="space-y-4 p-6">
              <div className="rounded-sm bg-muted p-4 neo-border neo-shadow-sm">
                ...
                <p className="mt-1 text-sm font-medium text-muted-foreground">
                  Luyện phát biểu, thuyết trình và trao đổi trong lớp học tự tin
                  hơn.
                </p>
              </div>
              <div className="rounded-sm bg-muted p-4 neo-border neo-shadow-sm">
                ...
                <p className="mt-1 text-sm font-medium text-muted-foreground">
                  Cải thiện phản hồi, trình bày ý tưởng và giao tiếp trong môi
                  trường áp lực.
                </p>
              </div>
              <div className="rounded-sm bg-muted p-4 neo-border neo-shadow-sm">
                ...
                <p className="mt-1 text-sm font-medium text-muted-foreground">
                  Bắt đầu với những bài luyện an toàn trước khi bước vào tình
                  huống thật.
                </p>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 py-12 md:py-16">
          <div className="mx-auto mb-10 max-w-2xl text-center">
            ...
            <p className="mt-3 text-base font-medium text-muted-foreground">
              Không chỉ học lý thuyết, bạn sẽ được thực hành liên tục để tăng
              phản xạ, sự tự nhiên và độ tự tin khi giao tiếp.
            </p>
          </div>
      ...
      <section className="container mx-auto px-4 py-12 md:py-16">
        <div className="mb-10 max-w-2xl">
          ...
          <p className="mt-3 text-base font-medium text-muted-foreground">
            Một hành trình đơn giản nhưng đủ thực chiến để bạn thấy sự tiến bộ
            rõ ràng sau mỗi lần luyện tập.
          </p>
        </div>
        ...
        <div className="container mx-auto px-4 py-12 md:py-16">
          <Card className="mx-auto max-w-5xl p-8 text-center neo-border-thick neo-shadow-lg md:p-12">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-base font-medium text-muted-foreground">
              Talki giờ sẽ giữ homepage gọn hơn. Chức năng đăng nhập và đăng ký
              chỉ hiện ra khi bạn bấm nút.
            </p>
